...
public class coupon_ZaiXian {

	public static void main(String[] args) throws JXLException, IOException, Exception {
		int count =0;
		//礼包基本信息数据在excel表Coupon的sheet：礼包基本信息
		Workbook wb =Workbook.getWorkbook(new File("D:\\Data\\coupon\\Sign_140423.xls"));
		Sheet st1 =wb.getSheet("签到(70)");
		//礼包基本信息数据在excel表Coupon的sheet：礼包配置
		Sheet st2=wb.getSheet("(70)附件");
